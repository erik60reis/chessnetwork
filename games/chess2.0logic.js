...
class Chess {
    ...
    constructor(fen = 'rnbqgkqbnr/pppppppppp/10/10/10/10/10/10/PPPPPPPPPP/RNBQGKQBNR w') {
        ...
        switch (piece.toLowerCase()) {
            ...
            case 'n': // Cavalo
                if (this.pieceTeam(this.board[toY][toX]) !== this.pieceTeam(this.board[fromY][fromX])) {
                    ...
                    if ((Math.abs(toX - fromX) === 4 && Math.abs(toY - fromY) === 2) || (Math.abs(toY - fromY) === 4 && Math.abs(toX - fromX) === 2)) {
                        return true;
                    }
                    if ((Math.abs(toX - fromX) === 6 && Math.abs(toY - fromY) === 3) || (Math.abs(toY - fromY) === 6 && Math.abs(toX - fromX) === 3)) {
                        return true;
                    }
                    if ((Math.abs(toX - fromX) === 8 && Math.abs(toY - fromY) === 4) || (Math.abs(toY - fromY) === 8 && Math.abs(toX - fromX) === 4)) {
                        return true;
                    }
                    if ((Math.abs(toX - fromX) === 10 && Math.abs(toY - fromY) === 5) || (Math.abs(toY - fromY) === 10 && Math.abs(toX - fromX) === 5)) {
                        return true;
                    }
                }
                break;
